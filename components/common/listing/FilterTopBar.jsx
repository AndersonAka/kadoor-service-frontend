    ...
    <>
      ...
      <div className="col-sm-12 col-md-8 col-lg-8 col-xl-5">
        <div className="right_area text-end tac-xsd">
          <ul className="d-flex align-items-center justify-content-end gap-3 mb-0" style={{ listStyle: 'none', padding: 0 }}>
            <li className="list-inline-item d-flex align-items-center">
              <span className="stts me-2" style={{ whiteSpace: 'nowrap' }}>Status:</span>
              <select
            ...
            <li className="list-inline-item d-flex align-items-center">
              <span className="shrtby me-2" style={{ whiteSpace: 'nowrap' }}>Sort by:</span>
              <select
                className="selectpicker show-tick"
