        ...
        <div className="container-kadoor">
          <div className="flex flex-col lg:flex-row items-center gap-12 max-w-5xl mx-auto">
            ...
            <div className="hidden lg:block flex-1">
              <div className="relative h-[650px] rounded-2xl overflow-hidden shadow-xl">
                <Image
                ...
                <div className="absolute bottom-8 left-8 right-8 text-white">
                  <h2 className="text-2xl font-bold mb-2">Rejoignez KADOOR SERVICE</h2>
                  <p className="text-white/80">Créez votre compte et accédez à nos services premium</p>
                </div>
              </div>
            </div>
